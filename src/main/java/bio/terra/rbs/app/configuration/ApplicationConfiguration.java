...
import static bio.terra.rbs.app.configuration.BeanNames.*;
import static bio.terra.rbs.app.configuration.BeanNames.JDBC_TEMPLATE;
import static bio.terra.rbs.app.configuration.BeanNames.OBJECT_MAPPER;

import bio.terra.rbs.app.StartupInitializer;
...
public class ApplicationConfiguration {
  @Bean(JDBC_TEMPLATE)
  public NamedParameterJdbcTemplate getNamedParameterJdbcTemplate(RbsJdbcConfiguration config) {
