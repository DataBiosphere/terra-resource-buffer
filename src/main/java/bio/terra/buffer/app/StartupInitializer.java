...
import bio.terra.buffer.service.cleanup.ResourceTableCleanupJob;
...
public final class StartupInitializer {
  ...
  public static void initialize(ApplicationContext applicationContext) {
    ...
    applicationContext.getBean(ResourceTableCleanupJob.class).initialize();
  ...
  private static void initializeStairwayComponent(ApplicationContext applicationContext) {
    ...
    applicationContext
        ...
        .initialize(
            ...
            applicationContext,
            ImmutableList.of(new MonitoringHook(applicationContext.getBean(OpenTelemetry.class))));
  }
}
