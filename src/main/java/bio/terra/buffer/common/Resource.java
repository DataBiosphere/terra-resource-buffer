...
/** Represents resource used in Resource Buffer Service.. */
@AutoValue
public abstract class Resource {
  /**
   * The unique id of the resources. Generated by Resource Buffer Service when creating the
   * resource.
   */
  ...
  /**
   * The time when Resource Buffer Service handed out resource to client. It is set when the
   * resource is handed out.
   */
  @Nullable
  public abstract Instant handoutTime();

  /** The time when Resource Buffer Service is deleted. It is set when the resource is deleted. */
  @Nullable
